...
function displayPics(){
  ...
  // The previous line of code threw an error since let is block scoped therefore there is only applied within the while loop that it is found in. Once we try to console.log it outside of the while loop there is no variable called rando and thus an error is thrown.
  console.log(viewed);
